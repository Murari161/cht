...
CREATE INDEX mv_sdx_notify_year ON cht.mv_sdx_notify USING btree (year) TABLESPACE ts_indexes;
CREATE INDEX mv_sdx_notify_month ON cht.mv_sdx_notify USING btree (month) TABLESPACE ts_indexes;
