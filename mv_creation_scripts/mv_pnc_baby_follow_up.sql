...
CREATE INDEX pnc_baby_follow_up_year_idx ON cht.mv_pnc_baby_follow_up USING btree (year) TABLESPACE ts_indexes;
CREATE INDEX pnc_baby_follow_up_month_idx ON cht.mv_pnc_baby_follow_up USING btree (month) TABLESPACE ts_indexes;
