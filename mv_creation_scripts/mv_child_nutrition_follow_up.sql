...
AS SELECT doc ->> '_id'::text AS id,
    ...
    (((((doc -> 'contact'::text) -> 'parent'::text) -> 'parent'::text) -> 'parent'::text) -> 'parent'::text) ->> '_id'::text AS district,
    ((((((doc -> 'contact'::text) -> 'parent'::text) -> 'parent'::text) -> 'parent'::text) -> 'parent'::text) -> 'parent'::text) ->> '_id'::text AS region,
