...
CREATE INDEX tb_follow_up_year_idx ON cht.mv_tb_follow_up USING btree (year) tablespace ts_indexes;
CREATE INDEX tb_follow_up_month_idx ON cht.mv_tb_follow_up USING btree (month) tablespace ts_indexes;
...
CREATE INDEX tb_follow_up_facility_name_idx ON cht.mv_tb_follow_up USING btree (facility_name) tablespace ts_indexes;
