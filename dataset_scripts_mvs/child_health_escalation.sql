...
SELECT
  --- indentifiers
    ...
    /* ===== Action taken ===== */
    doc #>> '{fields,action_taken,completed_referral_follow_up}'     AS completed_referral_follow_up,
    ...
    /* ===== Patient summary (notes/instructions) ===== */
    doc #>> '{fields,group_patient_summary,instruction}'               AS summary_instruction,      
    doc #>> '{fields,group_patient_summary,please_submit_this_form}'   AS summary_please_submit,       
    doc #>> '{fields,group_patient_summary,s_note_patient_details}'    AS summary_note_patient_details, 
    doc #>> '{fields,group_patient_summary,s_note_patient_details_values}' AS summary_note_patient_details_values, 
    doc #>> '{fields,group_patient_summary,s_note_follow_up_completed}' AS summary_follow_up_completed, 
    doc #>> '{fields,group_patient_summary,s_note_reason_for_no_follow_up}' AS summary_reason_for_no_follow_up, 
    doc #>> '{fields,group_patient_summary,s_note_vht_not_available}'  AS summary_vht_not_available,  
