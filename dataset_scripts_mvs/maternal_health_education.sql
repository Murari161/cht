CREATE MATERIALIZED VIEW report.useview_maternal_health_education
...
SELECT
   ...
   -- Top-level metadata 
    ...
    , doc #>> '{fields,health_education,select_health_condition}'::text[] AS topic
...
CREATE UNIQUE INDEX useview_maternal_health_education_uuid
    ON report.useview_maternal_health_education USING btree (uuid);

-- Helpful additional indexes
CREATE INDEX useview_maternal_health_education_reported
    ON report.useview_maternal_health_education USING btree (reported);
CREATE INDEX useview_maternal_health_education_patient
    ON report.useview_maternal_health_education USING btree ((doc #>> '{fields,patient_id}'));
