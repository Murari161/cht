...
SELECT
    ...
    doc #>> '{fields,needs_signoff}'                                    AS needs_signoff, --(true)
    doc #>> '{fields,referral_details,refer_to_health_facility}'        AS refer_to_health_facility, --(yes)
    doc #>> '{fields,referral_details,referral_reason}'        AS referral_reason,--(anc_danger_signs/newborn_danger_signs/missed_immunization_visits/experienced_onset_of_weakness)
