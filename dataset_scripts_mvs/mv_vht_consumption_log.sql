...
SELECT
    ...
    (doc #>> '{fields,items_received,act}')::int AS items_received_act,
    (doc #>> '{fields,items_received,malaria_rdts}')::int  AS items_received_malaria_rdts,
    (doc #>> '{fields,items_received,rectal}')::int  AS items_received_rectal,
    (doc #>> '{fields,items_received,gloves}')::int  AS items_received_gloves,
    (doc #>> '{fields,items_received,zinc}')::int  AS items_received_zinc,
    (doc #>> '{fields,items_received,amoxicillin}')::int  AS items_received_amoxicillin,
    (doc #>> '{fields,items_received,pop}')::int  AS items_received_pop,
    (doc #>> '{fields,items_received,coc}')::int  AS items_received_coc,
    (doc #>> '{fields,items_received,contraceptives}')::int  AS items_received_contraceptives,
    (doc #>> '{fields,items_received,dmpa}')::int  AS items_received_dmpa,
    (doc #>> '{fields,items_received,condoms}')::int  AS items_received_condoms,
    doc #>> '{fields,items_returned,return_note}'::text[] AS items_returned_return_note,
    (doc #>> '{fields,items_returned,act_r}')::int  AS items_returned_act_r,
    (doc #>> '{fields,items_returned,malaria_rdts_r}')::int  AS items_returned_malaria_rdts_r,
    (doc #>> '{fields,items_returned,rectal_r}')::int  AS items_returned_rectal_r,
    (doc #>> '{fields,items_returned,gloves_r}')::int  AS items_returned_gloves_r,
    (doc #>> '{fields,items_returned,zinc_r}')::int  AS items_returned_zinc_r,
    (doc #>> '{fields,items_returned,amoxicillin_r}')::int  AS items_returned_amoxicillin_r,
    (doc #>> '{fields,items_returned,pop_r}')::int  AS items_returned_pop_r,
    (doc #>> '{fields,items_returned,coc_r}')::int  AS items_returned_coc_r,
    (doc #>> '{fields,items_returned,contraceptives_r}')::int  AS items_returned_contraceptives_r,
    (doc #>> '{fields,items_returned,dmpa_r}')::int  AS items_returned_dmpa_r,
    (doc #>> '{fields,items_returned,condoms_r}')::int  AS items_returned_condoms_r,
